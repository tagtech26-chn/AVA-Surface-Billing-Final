...
public partial class AddInvoiceOperationalWorkflow : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.AddColumn<DateTime>(
            name: "WarehouseLoadedAtUtc",
            table: "Invoices",
            type: "datetime2",
            nullable: true);

        migrationBuilder.AddColumn<string>(
            name: "WarehouseVehicleNumber",
            table: "Invoices",
            type: "nvarchar(30)",
            maxLength: 30,
            nullable: true);
        ...
        migrationBuilder.CreateIndex(
            name: "IX_Invoices_CompanyId_WorkflowStatus_InvoiceDate",
            table: "Invoices",
            columns: new[] { "CompanyId", "WorkflowStatus", "InvoiceDate" });
    }
