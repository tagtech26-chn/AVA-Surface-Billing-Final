...
export interface Product { id: string; sku: string; barcode: string; name: string; category: string; costPrice: number; sellingPrice: number; stock: number; reorderLevel: number; taxRate: number; unit: string; hsnCode?: string; description?: string; imageUrl?: string; updatedAt: string; tileDimensions?: string; pcsPerBox?: number; sqftPerBox?: number; tileFinish?: string; tileType?: string; batchNo?: string; pricePerSqFt?: number; weightPerBoxKg?: number; sellingPricePerPcs?: number; sellingPricePerBox?: number; sellingPricePerSqFt?: number; sellingPricePerSqMt?: number; sellingPricePerSet?: number; }
