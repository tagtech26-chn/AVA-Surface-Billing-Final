...
type ServerInvoice = {
  ...
  vehicleNumber?: string; warehouseLoadedBy?: string; warehouseVerifiedBy?: string; warehouseLoadedAtUtc?: string; warehouseRemarks?: string; deliveredAtUtc?: string; deliveredByName?: string;
